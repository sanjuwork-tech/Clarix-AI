    ...
    <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden bg-gradient-navy">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center pt-20">
        ...
        >
          ...
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-display font-extrabold text-white leading-[1.1] mb-6 max-w-5xl">
            The Future of Chartered Accountancy is <span className="text-gradient">AI-Powered</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
            <a
              href="#waitlist"
              className="px-8 py-4 rounded-xl bg-primary text-primary-foreground font-bold text-lg flex items-center justify-center gap-2 shadow-[0_0_40px_rgba(212,175,55,0.3)] hover:shadow-[0_0_60px_rgba(212,175,55,0.5)] hover:-translate-y-1 transition-all duration-300"
            >
